...
def generate_story_with_pollinations(topic: str) -> str:
    ...
    system = "You are a historian specializing in ancient women history. Write a short 30-second interesting story (80-130 words) in French. Tell real historical facts, laws, customs, or traditions. Use a lively, captivating style. No titles."
    prompt = f"Theme: {topic}. Tell an interesting historical fact in French."
    ...
    for attempt in range(3):
        ...
        return f"Autrefois, dans le monde antique, les femmes façonnaient les lois, les coutumes et la vie quotidienne de manière remarquable. {topic}. Leurs histoires de courage, de savoir-faire et de résilience résonnent à travers l'histoire et nous inspirent encore aujourd'hui."
