...
def main():
    ...
    # French description - topic-relevant, no AI mentions
    description = f"""Découvrez l'histoire fascinante des femmes dans les civilisations anciennes.

Explorez les lois, les coutumes, les traditions et les figures emblématiques qui ont marqué l'histoire.

#Shorts #HistoireDesFemmes #HistoireAncienne #Éducation"""
